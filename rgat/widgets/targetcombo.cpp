...
void targetCombo::addTargetByPath(boost::filesystem::path filepath)
{
...
void targetCombo::addNewTarget()
{
	...
	addTargetByPath(filepath);
}

void targetCombo::loadRecent(QString pathString)
{
	boost::filesystem::path filepath(pathString.toStdString());
	addTargetByPath(filepath);
}