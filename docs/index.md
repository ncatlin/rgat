...
You can use the [editor on GitHub](https://github.com/ncatlin/rgat/edit/master/docs/index.md) to maintain and preview the content for your website in Markdown files.
