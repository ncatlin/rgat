        ...
        static void Main(string[] args)
        {
            ...
            switch(GlobalConfig.StartOptions.RunMode)
            {
                ...
                case LaunchConfig.eRunMode.GPURenderCommand:
                    ...
                    runner.InitGPU();
                    runner.TraceBinary(GlobalConfig.StartOptions.TargetPath, saveDirectory: GlobalConfig.StartOptions.TraceSaveDirectory, recordVideo: GlobalConfig.StartOptions.VideoTracingPath);
