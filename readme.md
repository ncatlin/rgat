...
It (version 0.1.4) is [here](https://github.com/ncatlin/rgat/raw/master/rgat-0.1.3.zip) for Windows x86 targets only, at the moment. Most of the file size is the included minimal DynamoRIO distribution.
